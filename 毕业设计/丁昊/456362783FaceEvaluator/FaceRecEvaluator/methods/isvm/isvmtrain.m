% ISVMTRAIN - Trains a support vector machine incrementally
...
function [a,b,g,ind,uind,X,y,Rs,Q] = isvmtrain(X_new,y_new,C_new,varargin)
...
num_learned = 1;
if verbose, disp('Beginning training.'); end
...
if verbose, disp('Training complete!'); end
