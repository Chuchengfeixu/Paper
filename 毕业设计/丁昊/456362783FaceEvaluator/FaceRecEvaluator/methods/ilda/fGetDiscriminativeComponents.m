function [DiscriminativeComponents S_N] = fGetDiscriminativeComponents(totalEigVect, totalEigVal, betweenEigVect, betweenEigVal, outNSample,eigenThreshold, dimScatterMatrix)
% -----------------------------------------------------------------------
...
if size(totalTermFactorZ, 2) < dimScatterMatrix
	dimScatterMatrix = size(totalTermFactorZ, 2);
end
totalTermFactorZ = totalTermFactorZ(:,1:dimScatterMatrix);
