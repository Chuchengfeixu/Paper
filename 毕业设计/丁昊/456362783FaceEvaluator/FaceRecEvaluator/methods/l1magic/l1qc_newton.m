...
while (~done)
  ...
  if (verbose), disp(sprintf('Newton iter = %d, Functional = %8.3f, Newton decrement = %8.3f, Stepsize = %8.3e, Cone iterations = %8.3f, Backtrack iterations = %d', niter, f, lambda2/2, stepsize, coneiter, backiter)); end
  if (largescale)
